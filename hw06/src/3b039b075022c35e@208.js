...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["artistVer (1) - artistVer (1).csv", {url: new URL("../artistVer.csv", import.meta.url), mimeType: "text/csv", toString}],
    ["artistPublic (1) - artistPublic (1).csv", {url: new URL("../artistPublic.csv", import.meta.url), mimeType: "text/csv", toString}]
  ]);
